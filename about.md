...
## 关于时间线
- [首页时间线]({{ site.baseurl }}/index/)上以收录修学旅行/狐猪**强相关**事件为主。
- 单人物料如果提到对方一定会揪出来收录（笑）
- 所有平台原链接会尽量收录。
- 粉色文字是站长的嗑糖记录+碎碎念。
- 单人资讯会单独收录在[【单人物料】]({{ site.baseurl }}/solo/)中且以狐猪相遇起点为界往后收录。
- 关于事件合并：首页时间线和单人物料都以会合并到事件当日；在[【平铺时间线】]({{ site.baseurl }}/flattened_timeline/)里会同步备份一份按日期平铺的时间线。
