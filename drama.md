...
[【修仲百景】]({{ site.baseurl }}/tmi/) *=修仲剧版TMI。标题来源: 柴田陽一郎*{: .text-small}
...
> 出演:藤本洸大、簡秀吉、桜木雅哉(原因は自分にある。)、福田歩汰(DXTEEN)、清水海李、水戸由菜、山田健人、相羽星良、彩香、泉有乃 ほか
> 脚本:山下すばる
> 音楽:鈴木ヤスヨシ
> 主題歌:「両片想い」DXTEEN
...
* **播出时间/标题**
    ...
    > 251206 25:00~ 第8话「泣いてさらけ出す恋心」
    > 251213 25:00~ 第9话「文化祭、初恋に戸惑う」
    > 251220 25:00~ 第10话「一生心に残り続けていく日々」(最终回)
    > 251228 0:00~ 番外篇前篇「息もできない」
    > 260104 0:00~ 番外篇后篇「嵐の夜」
* **分集剧情**
    > 1:
...
* **演员表**
    ...
    --- 羽毛球部 ---
    > 辻谷萊空 - 山田健人 [Ins](https://www.instagram.com/kento___092997/)
    > 水無瀬葵 - 下村未空 [Ins](https://www.instagram.com/shimomura_misora_official/)
    ...
    ---  其他 ---
    > 池ヶ谷杏那 - 岩波詩織 [X](https://x.com/shiori_iwanami)/[Ins](https://www.instagram.com/shiori.iwanami/)
...
* **TVer收藏数** 最高28.3万收藏
> **2025(日站+豆瓣追剧帖统计)**
    > 2.1万→4.4万→5万(9/30)→6.4万→8万(10/11)→8.1万
    > 9.8万①→11.1万(10/19)→12.3万(10/20)→13万(10/21)→13.8万(10/22)
    > 15.1万②→17万(10/30)
    > 17.5万③→18万(11/3)→18.8万(11/6)→19万(11/7)
    > 19.5万④(11/7)→20万(11/9)→20.8万(11/12)→21万(11/14)
    > 21.3万⑤→21.8万(11/16)→22.1万(11/17)→23万(11/20)
    > 23.6万⑥
    > 24.9万⑦→25.1万(11/30)→25.6万(12/2)
    > 26.1万⑧(12/6)→27万(12/11)
    > 27.3万⑨→28万(12/18)
    > 28.3万（L）27.4万→27.1万(1/9)
> **2026再放送** 26.1万(7/4)①→27.1万(7/11)②→27.8万(7/26)③→27.9万(8/3)④→28万(8/8)⑤→28.3万(8/12)*第一季最高点*{: .text-red}→28.7万(8/22)⑥→29万(9/2)→29.2万(9/5)⑦→29.8万(9/12)⑧→30万(9/14)→31.2万(9/20)
* **TVer实时电视剧榜排名**
> 1话: 最高12位(10/20)
> 2话: 最高11位(10/26)
> 3话: 最高9位(11/2)
...
> <span>[第二季宣布]</span>{: .text-red}→<span>33.3万(8/11)</span>{: .text-blue}→33.9万(8/21)→34.2万(8/31)→34.5万(9/10)→34.8万(9/20)
...
> <span>[第二季宣布]</span>{: .text-red}→<span>23.4万(8/11)</span>{: .text-blue}→23.7万(8/21)→24万(8/31)→24.1万(9/10)→24.3万(9/20)

> **官号(X):** <span>2.53万(25/8/8)</span>{: .text-blue}→4万(11/10)→7万(26/1/5)→<span>[第二季宣布]</span>{: .text-red}→<span>7.86万(8/11)</span>{: .text-blue}→8万(8/31)→8.2万(9/10)→8.48万(9/20)

> **官号(ins):** <span>2.87万(25/8/8)</span>{: .text-blue}→5万(11/9)→6.5万(11/21)→8万(12/2)→8.9万(12/10)→<span>11.1万(12/28)</span>{: .text-red}→11.8万(26/1/4)→11.9万(1/5)→12万(1/6)→13万(2/14)→<span>[第二季宣布]</span>{: .text-red}→<span>13.7万(8/11)</span>{: .text-blue}→14.2万(8/31)→14.8万(9/10)→15.2万(9/20)

> **官号(抖音):** <span>0(25/9/22)</span>{: .text-blue}→14.3万(26/1/5)→15.1万(1/18)→16万(2/20)→16.2万(3/20)→<span>[第二季宣布]</span>{: .text-red}→<span>15.7万(8/11)</span>{: .text-blue}→16.7万(8/31)→16.8万(9/10)→17.3万(9/20)
...
* 260115～260122 GagaOOLala BL周榜4位 (豆瓣)
...
* 251114～251120 第5回 GagaOOLala BL周榜1位 (豆瓣)
...
* 251030～251106 第3回 GagaOOLala BL周榜1位 (豆瓣)
